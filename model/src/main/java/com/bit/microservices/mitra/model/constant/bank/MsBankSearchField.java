package com.bit.microservices.mitra.model.constant.bank;
...
@Getter
public enum MsBankSearchField implements EnumColumnFilterBy {
    ...
    MsBankSearchField(Class<? extends Serializable> childPath, Path<?> path, String nameColumn, String requestName, FilterColumnRequestType type, Class<? extends EnumAction> enumClass) {
