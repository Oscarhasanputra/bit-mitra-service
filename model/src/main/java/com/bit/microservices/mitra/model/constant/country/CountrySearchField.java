package com.bit.microservices.mitra.model.constant.country;
...
public enum CountrySearchField implements EnumColumnFilterBy {
    ...
    CountrySearchField(Class<? extends Serializable> childPath, Path<?> path, String nameColumn, String requestName, FilterColumnRequestType type, Class<? extends EnumAction> enumClass) {
