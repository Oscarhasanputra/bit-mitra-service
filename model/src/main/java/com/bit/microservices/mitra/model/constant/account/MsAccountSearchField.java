package com.bit.microservices.mitra.model.constant.account;
...
@Getter
public enum MsAccountSearchField implements EnumColumnFilterBy {
    ...
    MsAccountSearchField(Class<? extends Serializable> childPath, Path<?> path, String nameColumn, String requestName, FilterColumnRequestType type, Class<? extends EnumAction> enumClass) {
