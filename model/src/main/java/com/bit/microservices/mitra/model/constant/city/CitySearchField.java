package com.bit.microservices.mitra.model.constant.city;
...
@Getter
public enum CitySearchField implements EnumColumnFilterBy {
    ...
    CitySearchField(Class<? extends Serializable> childPath, Path<?> path, String nameColumn, String requestName, FilterColumnRequestType type, Class<? extends EnumAction> enumClass) {
