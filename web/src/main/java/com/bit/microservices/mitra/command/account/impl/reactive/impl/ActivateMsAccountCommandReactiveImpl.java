...
@Component
@Slf4j
public class ActivateMsAccountCommandReactiveImpl implements ActivateMsAccountCommandReactive {
    ...
    @Override
    public Mono<List<BaseResponseDTO>> execute(List<ActivateRequestDTO> request, ModuleCodeEnum module, CrudCodeEnum crud, MandatoryHeaderRequestDTO mandatoryHeaderRequestDTO) {
        return this.commandExecutor.executeAsReactive(ActivateMsAccountCommand.class,request,module,crud,mandatoryHeaderRequestDTO)
