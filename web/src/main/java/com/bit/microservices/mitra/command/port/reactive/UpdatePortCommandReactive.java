...
public interface UpdatePortCommandReactive extends CommandReactive<List<BaseResponseDTO>, List<UpdatePortRequestDTO>> {
    @Override
    default boolean isNeedValidate(List<UpdatePortRequestDTO> request) {
        return true;
    }
}
