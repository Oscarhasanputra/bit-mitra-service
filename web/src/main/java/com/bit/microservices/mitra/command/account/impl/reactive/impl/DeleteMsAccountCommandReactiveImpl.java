...
@Component
@Slf4j
public class DeleteMsAccountCommandReactiveImpl implements DeleteMsAccountCommandReactive {
    @Autowired
    ...
    @Override
    public Mono<List<BaseResponseDTO>> execute(List<DeleteRequestDTO> request, ModuleCodeEnum module, CrudCodeEnum crud, MandatoryHeaderRequestDTO mandatoryHeaderRequestDTO) {
        return this.commandExecutor.executeAsReactive(DeleteMsAccountCommand.class,request,module,crud,mandatoryHeaderRequestDTO)
